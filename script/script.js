...
// let kaloriya = document.forms.kaloriya

// kaloriya.onsubmit = (event) => {
//     event.preventDefault()

//     let data = {}

//     let fmdata = new FormData(kaloriya)
...
premium.onclick = () => {
    fitnes.classList.remove('tabheader__item_active')
    post.classList.remove('tabheader__item_active')
    balans.classList.remove('tabheader__item_active')
...
balans.onclick = () => {
    fitnes.classList.remove('tabheader__item_active')
    premium.classList.remove('tabheader__item_active')
    balans.classList.add('tabheader__item_active')
    post.classList.remove('tabheader__item_active')
